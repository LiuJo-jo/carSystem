...
public class MybatisPlusUtil {
    /** 作者 */
    public static final String AUTHOR = "liuxiaobao";
     ...
     * Service命名
     */
    public static final String PACKAGE_NAME_SERVICE = "server";
    /**
     * ServiceImpl命名
     */
    public static final String PACKAGE_NAME_SERVICE_IMPL = "server.impl";
    /**
     * Controller命名
     */
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://10.1.0.236:3306/xb-styde?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&useSSL=true");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("developer");
        dsc.setPassword("developer&qx123456");
